...
erbool sys_mkdir (char *path) GNUC_NONNULL GNUC_WARN_UNUSED_RES;

erbool sys_unlink (const char *filename) GNUC_NONNULL GNUC_WARN_UNUSED_RES;

#ifdef ENGINE_SYS_PRINTF

void sys_printf_real (const char *file, int line, const char *func, const char *format, ...)
    GNUC_PRINTF(4, 5) GNUC_NONNULL;
